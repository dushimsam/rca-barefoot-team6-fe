  ...
  <div className="w-full max-w-screen-xl px-4 mx-auto lg:px-12">
    ...
    <div className="relative overflow-hidden bg-white shadow-xl text-black sm:rounded-lg">
      <div className="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
        <div>
          <h5 className="mr-3 font-semibold text-black">Barefoot Users</h5>
          <p className="text-gray-500 dark:text-gray-600">Manage all your existing users or add a new one</p>
        </div>
        <button type="button" 
