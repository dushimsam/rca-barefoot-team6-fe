					...
					<table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
						...
						<tbody>
							{hotels.map((hotel: HotelInfos, i) => (
								<tr
									className='bg-white border-b drop-shadow-xl py-1 rounded text-gray-900'
									key={i}
								>
									...
									<td className='px-6 py-4 text-gray-900'>{hotel.email}</td>
									<td className='px-6 py-4 text-gray-900'>{hotel.website}</td>
									<td className='px-6 py-4 text-gray-900'>{hotel.address}</td>
